...
-- 1-to-1 Match with TurtleRP Icon Index for Wire Compatibility
PUIRoleplay.Icons = {
"Ability_Ambush",
  "Ability_BackStab",
  "Ability_BullRush",
...
-- Reverse Icon Path lookup table
PUIRoleplay.IconToIndex = {}
for i, iconName in ipairs(PUIRoleplay.Icons) do
    PUIRoleplay.IconToIndex[iconName] = i
    PUIRoleplay.IconToIndex[string.lower(iconName)] = i
end
